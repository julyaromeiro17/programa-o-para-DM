...
void main() {
  ...
  while (rodando) {
    ...
    print('================================');
    print('1. Jogo 1: Adivinhe qual é  o Número');
    print('2. Jogo 2: Jokenpô ✌🏽');
    print('0. Sair');
...
// ==========================================
// JOGO 1: ADIVINHE QUAL É O NÚMERO
// ==========================================
...
void jogarAdivinhacao() {
  ...
  int tentativasRestantes = 5; // Desafio 2: Limite de 5 tentativas
  bool acertou = false;
...
void jogarJokenpo() {
  ...
  while (vitoriasJogador < 3 && vitoriasComputador < 3) {
    ...
    } else if ((jogadaJogador == Jogada.pedra &&
            jogadaComputador == Jogada.tesoura) ||
  ...
  print('\n==============================');
  print('       FIM DO JOKENPÔ         ');
  print(
    'Placar Final -> Você: $vitoriasJogador | Computador: $vitoriasComputador',
  );
