...
void main() {
  var heroi = HeroiAvancado("Gandalf", 80, 10);
  var orc = Personagem("Orc", 90, 8);

  print("⚔️ A PARTIDA COMEÇOU! ⚔️\n");

  List<Item> itensPossiveis = [
    Item("Espada de Bronze", 5),
  ...
  print("\n🏆 FIM DE JOGO!");
  if (heroi.estaVivo()) {
    print("${heroi.nome} derrotou o Orc e é o vitorioso!");
  } else {
    print("O Orc derrotou ${heroi.nome}. Tente novamente!");
  }
}