...
void main() {
  ...
  for (int i = 1; i <= 2; i++) {
    ...
    stdout.write("Digite o ID do jogador: ");
    String id = stdin.readLineSync() ?? "";
    
    stdout.write("Digite o Nome do jogador: ");
    ...
    while (!dadosValidos) {
      stdout.write("Digite o valor da Força (mínimo 10): ");
      forca = int.tryParse(stdin.readLineSync() ?? "") ?? 0;

      stdout.write("Digite o valor da Vida (mínimo 10): ");
      ...
      if (forca >= 10 &&
        ...
        print("Registo recusado, força no minimo 10 e vida no minimo 10");
      }
  ...
  while (true) {
    ...
    String resumo =
        ...
        "atacou ${jogadores[defensor]!["nome"]} "
